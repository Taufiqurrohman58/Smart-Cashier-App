...
class RekomendasiStokScreen extends StatefulWidget {
  const RekomendasiStokScreen({super.key});

  @override
  State<RekomendasiStokScreen> createState() => _RekomendasiStokScreenState();
}

class _RekomendasiStokScreenState extends State<RekomendasiStokScreen> {
